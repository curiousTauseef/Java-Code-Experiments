...
public class RomanObject {
    ...
    //Constructor that simply checks whether the lower and upper bound values
    // for the int are within the expected range


    public RomanObject(int arabic) {
    ...
    public RomanObject(String roman) {
